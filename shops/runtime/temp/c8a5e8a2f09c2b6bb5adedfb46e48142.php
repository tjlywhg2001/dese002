<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:73:"H:\gitfiles\dese002\shops\public/../application/admin\view\brand\add.html";i:1524908756;s:66:"H:\gitfiles\dese002\shops\application\admin\view\common\_meta.html";i:1524905587;s:64:"H:\gitfiles\dese002\shops\application\admin\view\common\top.html";i:1524905688;s:65:"H:\gitfiles\dese002\shops\application\admin\view\common\left.html";i:1524905868;s:67:"H:\gitfiles\dese002\shops\application\admin\view\common\footer.html";i:1524905751;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="username" placeholder="" name="username" type="text"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="username" placeholder="" name="username" type="file">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="float: left; padding-right: 10px;">
                                    <label>
                                        <input class="inverted colored-blue" value="1" name="username" type="radio">
